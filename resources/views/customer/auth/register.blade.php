...
<body>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="form-wrapper mx-auto">
                            <div class="form-header text-center mb-4">
                                <h2 class="text-center" style="font-size: 2.2rem; font-family: 'Oswald', sans-serif;">Registro de usuario</h2>
                                <p class="text-center mt-2">Crea tu cuenta para acceder a nuestros servicios.</p>
                            </div>

                            <!-- Google Auth Button -->
                            <button type="button" id="btnGoogleRegister" class="btn-google">
                            ...
                            <form id="registerForm" action="#" method="POST">
                                <div class="row g-4">
                                    <div class="col-12 form-group mb-0">
                                        ...
                                        <input type="text" class="form-control form-control-custom" id="name" name="name" placeholder="Ingresa tu nombre" required>
                                    </div>
                                    <div class="col-12 form-group mb-0">
                                        <label class="form-label-custom" for="email">Correo electrónico</label>
                                        <input type="email" class="form-control form-control-custom" id="email" name="email" placeholder="Ingresa tu correo electrónico" required>
                                    </div>
                                    <div class="col-12 form-group mb-0">
                                        <label class="form-label-custom" for="username">Usuario</label>
                                        <input type="text" class="form-control form-control-custom" id="username" name="username" placeholder="Crear tu usuario" required>
                                    </div>
                                    <div class="col-12 form-group mb-0">
                                        <label class="form-label-custom" for="password">Contraseña</label>
                                        <input type="password" class="form-control form-control-custom" id="password" name="password" placeholder="Crear tu contraseña" required>
                                    </div>
                                    <div class="col-12 mt-4">
                                        <button class="btn-submit-custom" type="submit" id="btnEmailRegister">Registrar <i class="fas fa-user-check ms-2"></i></button>
                                    </div>
    ...
    <script>
        ...
        // Google Auth Logic
        document.getElementById('btnGoogleRegister').addEventListener('click', async (e) => {
            e.preventDefault();
        ...
        document.getElementById('registerForm').addEventListener('submit', async (e) => {
            ...
            if (error) {
                ...
                alert('Registro exitoso. Revisa tu correo para verificar tu cuenta si es requerido, o inicia sesión.');
                window.location.href = '/customer/dashboard';
            }
        });
    </script>
