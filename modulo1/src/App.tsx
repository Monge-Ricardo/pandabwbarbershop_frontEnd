            ...
            element={
              <ProtectedRoute>
                <div className="min-h-screen bg-obsidian flex flex-col justify-center items-center text-center p-6 border border-border-color">
                  <h1 className="text-gold text-4xl font-heading mb-4">Dashboard del Barbero</h1>
                  <p className="text-text-muted max-w-md">Este es el Módulo 2, reservado para tus compañeros. La sesión actual de Barbero funciona correctamente.</p>
